(()=>{
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    @media(max-width:520px){.vehicleFilterTitle{font-size:12.5px !important}.vehicleFilterMeta{font-size:10px !important}#statusActions{gap:6px}.hero #allCarsLink{height:38px;padding:0 11px;font-size:11.5px}.hero #statusActions .status{height:38px}.shell>section.card:nth-of-type(1)>.sectionHead,.shell>section.card:nth-of-type(2)>.sectionHead{padding-bottom:10px;margin-bottom:3px}#scanSummary{margin-top:2px}.vehicleFilters{padding-top:5px !important}.matchList{margin-top:8px !important}#rules{margin-top:1px}.rule{padding:12px 0 !important}.rule:first-child{padding-top:8px !important}.rule:last-child{padding-bottom:4px !important}#formCard.formCard{top:auto !important;bottom:12px !important;transform:translateX(-50%) translateY(18px);width:calc(100vw - 20px) !important;max-height:calc(100dvh - 32px);border-radius:22px !important;padding:20px !important}#formCard.formCard.open{transform:translateX(-50%) translateY(0)}}`;
