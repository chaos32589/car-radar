(()=>{
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    #statusActions{display:flex;align-items:center;gap:8px;margin-top:10px;flex-wrap:wrap}.hero #statusActions .status{margin-top:0 !important;height:40px}.hero #allCarsLink{display:inline-flex;align-items:center;justify-content:center;gap:6px;margin:0 !important;height:40px;padding:0 13px;border:1px solid #6f7df0;border-radius:999px;background:rgba(111,125,240,.16);color:#c9ceff;text-decoration:none;font-size:12px;font-weight:700;line-height:1;white-space:nowrap;box-shadow:inset 0 0 0 1px rgba(157,168,255,.08),0 0 18px rgba(111,125,240,.08)}#allCarsLink svg{width:14px;height:14px;display:block;flex:none;color:#aeb8ff}#allCarsLink:active{background:rgba(111,125,240,.26);color:#fff;border-color:#8f9bff}
