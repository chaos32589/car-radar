(()=>{
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    #allCarsLink{display:inline-flex;align-items:center;gap:6px;margin-left:10px;padding:8px 13px;border:1px solid #293242;border-radius:999px;background:#121923;color:#aab3c5;text-decoration:none;font-size:12px;line-height:1;vertical-align:middle;white-space:nowrap}#allCarsLink svg{width:14px;height:14px;display:block}#allCarsLink:active{background:#18212d;color:#fff}
    ...
    @media(max-width:520px){.vehicleFilterTitle{font-size:12.5px !important}.vehicleFilterMeta{font-size:10px !important}#allCarsLink{margin-left:8px;padding:8px 11px;font-size:11.5px}#formCard.formCard{top:auto !important;bottom:12px !important;transform:translateX(-50%) translateY(18px);width:calc(100vw - 20px) !important;max-height:calc(100dvh - 32px);border-radius:22px !important;padding:20px !important}#formCard.formCard.open{transform:translateX(-50%) translateY(0)}}`;
