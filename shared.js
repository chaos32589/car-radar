(()=>{
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    @media(max-width:520px){.vehicleFilterTitle{font-size:12.5px !important}.vehicleFilterMeta{font-size:10px !important}#statusActions{gap:6px}.hero #allCarsLink{height:38px;padding:0 11px;font-size:11.5px}.hero #statusActions .status{height:38px}#scanSummary{margin-top:2px}.vehicleFilters{padding-top:5px !important}.matchList{margin-top:8px !important}#formCard.formCard{top:auto !important;bottom:12px !important;transform:translateX(-50%) translateY(18px);width:calc(100vw - 20px) !important;max-height:calc(100dvh - 32px);border-radius:22px !important;padding:20px !important}#formCard.formCard.open{transform:translateX(-50%) translateY(0)}}`;
